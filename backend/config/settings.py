...
SESSION_COOKIE_SECURE = _env_bool('SESSION_COOKIE_SECURE', default=IS_PRODUCTION or not DEBUG)
CSRF_COOKIE_SECURE = _env_bool('CSRF_COOKIE_SECURE', default=IS_PRODUCTION or not DEBUG)
